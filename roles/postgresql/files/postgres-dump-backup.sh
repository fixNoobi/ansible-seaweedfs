...
# crontab - 00 11,16,21 * * * /var/lib/postgresql/postgres-dump-backup.sh >> /var/lib/postgresql/11/backup/log/postgres-dump-backup.log

# Host name (or IP address) of PostgreSQL server e.g. localhost
DBHOST=localhost

# List of DBNAMES for Daily/Weekly Backup e.g. "DB1 DB2 DB3"
DBNAMES="gettransfer gettransfer_stage"

# Backup directory location e.g /backups
#-#BACKUPDIR="/path/to/backup"
BACKUPDIR="/var/lib/postgresql/11/backup/dump"
...
DATE=`date +%Y-%m-%d_%H-%M`                     # Datestamp e.g. 2018-12-20 12:12:12
...
#OPT="-Fc"                                       # OPT string for use with mysqldump ( see man mysqldump )
...
echo ======================================================================
echo AutoPostgreSQLBackup $VER
echo https://gettransfer.com
echo
...
echo ======================================================================
    ...
    # Daily Backup
        ...
        echo
            dbdump "$DB" "$BACKUPDIR/daily/$DB/${DB}_$DATE.dump"
...
echo ======================================================================
    ...
    # Daily Backup
        ...
        echo
            dbdump "$DBNAMES" "$BACKUPDIR/daily/$DATE.dump"
